...
print("\n##### Stats on Train Data #####\n")
print(f"Score: {reg.score(feature_train, target_train)}")
print("\n##### Stats on Test Data #####\n")
print(f"Score: {reg.score(feature_test, target_test)}")
...
print(f"Slope New: {reg.coef_}")
print(f"Intercept New: {reg.intercept_}")
